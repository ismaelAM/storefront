...
export async function CategoryBanner({
  ...
  return (
    <>
      {showHero && (
        <div
          className="flex min-h-[350px] flex-col justify-end bg-gray-50 bg-cover bg-center"
          style={
            category.image_url
          ...
          <div className="flex flex-wrap items-center gap-2 border-b border-gray-100 pb-4">
            {category.children.map((child) => (
              <Link
                ...
                className="rounded-lg px-1.5 py-1 text-gray-700 transition-colors hover:bg-gray-100"
              >
                {child.name}
              </Link>
            ))}
