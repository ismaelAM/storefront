...
- [x] Corregida en Spree la configuración duplicada de envío `Default` / `Predeterminado`; el storefront sigue limitándose a mostrar las `delivery_rates` que devuelve Spree.
...
- [x] Eliminada la configuración de envío duplicada `Default` / `Predeterminado` en Spree.
